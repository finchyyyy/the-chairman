...
^ so the basic cycling clause becomes "If it is your turn, you may cycle [???]s."
...
^ so each player enters with a deck of 54(?) cards
...
^ being able to shed your hand is still rewarded because you get to draw 3/5/7 cards in a turn
^ rules violations are now punished by adding cards to your deck instead of your hand (from hand or table?)

> rules cards can be part of your deck, and now they can also possibly only apply to you/your opponent
