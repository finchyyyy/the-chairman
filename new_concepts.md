...
> [03/08]
> until the end of the turn? this was originally the case
> also maybe instead add the tags to the card already on the Play Pile? This allows it to clear bricks
...
Rules cards can be part of your deck - they are added in addition to your standard deck of 54
When you play a Rule Card, you may choose to place it in any of 1.your own, 2.your opponents, or 3.the State's Rules Zone
...
> in the 26/05 game, i modified it to last until 6 cards had been played (put d6 infront of each affected player)
...
> last, i want to change the card value order: King is highest, Ace is low but beats King
...
> Not sure about the effect that keeps it in the deck though, I like it as a "if theres a seven on top, draw two to look at your opponent's hand." (when we were playing, it was just an agreement to keep it in the deck, not a seperate piece of Rules Text.) (also kinda messes up game flow, as its kinda a brick when it comes down...)
